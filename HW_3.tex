...
\begin{alphaparts}
  ...
  \questionpart %---------------------------------------------------------
  Se \(c = \mathbbm{1}\) allora \(y =  \sum \limits_{i=1}^{n} x_i^* =  \sum \limits_{i=1}^{n} z_i\), dove \(z\) è il vettore di centralità di Katz come è stato definito al punto (d). Pertanto se il \textit{key-player} è quel giocatore \(i^*\) la cui rimozione comporti la maggior riduzione di y allora vale:
  \begin{gather*}
    i^* = \argmax \limits_{i \in \mathcal{V}} z_i.
  \end{gather*}
