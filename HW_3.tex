...
\section{} %------ ESERCIZIO 2 ---------------------------------------
Sia  \(\mathcal{G}=(\mathcal{V}, \varepsilon, W)\) un grafo di ordine \(n = | \mathcal{V}| \geq 2\) privo di self loop tale che ogni nodo abbia grado uscente \(\omega_1 > 0\). Si considera un gioco tra i giocatori \(\mathcal{V}\), ciascuno con spazio delle azioni \(\mathcal{A} = \mathbb{R}\) e funzioni di utilità
\begin{gather*}
...
\begin{alphaparts}
  ...
  \end{gather*}
  Poiché \(\beta_k\) e \(\mu\) sono rispettivamente uno scalare e un vettore che rappresentano parametri arbitrari relativi alla \textit{centralità intrinseca}, è possibile porre i seguenti valori:
  \begin{gather*}
  ...
  \begin{gather*}
    y = \sum \limits_{j \in \mathcal{V}} x_j^* = \sum \limits_{j \in \mathcal{V}} (M\mathbbm{1})_j = \sum \limits_{i \in \mathcal{ V}} \sum \limits_{j \in \mathcal{ V}} M_{ij} > 0   
    \\  y^{(-i)} = \sum \limits_{j \neq i} x_j^{*(-i)} = \sum \limits_{j \in \mathcal{V}^{(-i)}} (M\mathbbm{1})_j = \sum \limits_{i \in \mathcal{ V}^{(-i)}} \sum \limits_{j \in \mathcal{ V}^{(-i)}} M^{(-i)}_{ij} > 0   
  \end{gather*}
  per questo motivo vale:
  \begin{gather*}
    \argmax \limits_{i \in \mathcal{V}} y - y^{(-i)} = \argmin \limits_{i \in \mathcal{V}} y^{(-i)} = 
    \argmin \limits_{i \in \mathcal{V}}\left( \sum \limits_{i \in \mathcal{ V}^{(-i)}} \sum \limits_{j \in \mathcal{ V}^{(-i)}} M^{(-i)}_{ij}  \right).
  \end{gather*}
  Utilizzando il punto (g) si ottiene:
  \begin{gather*}
    \argmin \limits_{i \in \mathcal{V}}\left( \sum \limits_{i \in \mathcal{ V}^{(-i)}} \sum \limits_{j \in \mathcal{ V}^{(-i)}} M^{(-i)}_{ij}  \right) = \argmin \limits_{i \in \mathcal{V}}\sum \limits_{i \in \mathcal{ V}^{(-i)}} \sum \limits_{j \in \mathcal{ V}^{(-i)}} \left(\frac{M_{ii}M_{jk}-M_{ij}M_{ik}}{M_{ii}}\right) = \\
    \argmin \limits_{i \in \mathcal{V}} \left(\sum \limits_{i \in \mathcal{ V}^{(-i)}} \sum \limits_{j \in \mathcal{ V}^{(-i)}} M_{jk}- \sum \limits_{i \in \mathcal{ V}^{(-i)}} \sum \limits_{j \in \mathcal{ V}^{(-i)}} \frac{M_{ij}M_{ik}}{M_{ii}} \right) = \\
    \argmax \limits_{i \in \mathcal{V}} \left(\sum \limits_{i \in \mathcal{ V}^{(-i)}} \sum \limits_{j \in \mathcal{ V}^{(-i)}} \frac{M_{ij}M_{ik}}{M_{ii}} \right).
  \end{gather*}
